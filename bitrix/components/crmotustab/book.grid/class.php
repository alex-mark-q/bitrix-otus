...
use Otus\Models\ORM\HospitalTable;
use Bitrix\Main\Loader;
use Bitrix\Main\ORM\Query\Result;

Loader::includeModule('crm.otustab');
class HospitalGrid extends \CBitrixComponent implements Controllerable
{
    ...
    private function getHeaders(): array
    {
        return [
            ...
            [
                'id' => 'TITLE',
                'name' => Loc::getMessage('HOSPITAL_GRID_BOOK_TITLE_LABEL'),
                'sort' => 'TITLE',
                'default' => true,
            ],
            [
                'id' => 'YEAR',
                'name' => Loc::getMessage('HOSPITAL_GRID_BOOK_PUBLISHING_YEAR_LABEL'),
                'sort' => 'YEAR',
                'default' => true,
            ],
            [
                'id' => 'PAGES',
                'name' => Loc::getMessage('HOSPITAL_GRID_BOOK_PAGES_LABEL'),
                'sort' => 'PAGES',
                'default' => true,
            ],
            [
                'id' => 'AUTHORS',
                'name' => Loc::getMessage('HOSPITAL_GRID_BOOK_AUTHORS_LABEL'),
                'default' => true,
            ],
            [
                'id' => 'PUBLISH_DATE',
                'name' => Loc::getMessage('HOSPITAL_GRID_BOOK_PUBLISHING_DATE_LABEL'),
                'sort' => 'PUBLISH_DATE',
                'default' => true,
            ],
        ];
    ...
    private function prepareGridData(): void
    {
        ...
        $bookIdsQuery = HospitalTable::query()
            ->setSelect(['ID'])
            ->setFilter($filter)
